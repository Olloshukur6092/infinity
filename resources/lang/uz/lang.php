...
return [
    ...
    //body
    'Bizni_Jamoamiz_tajribali'=>"Bizni Jamoamiz tajribali o'z ishing ustalaridan iborat bizga har qanday loyiha bo'yicha murojat qilishingiz mumkin.",    
    'Mukammal_proyektlar' => "Mukammal proyektlar",
    'Professional_xodimlar' => " Professional xodimlar",
    '24/7_Qollabquvvatlash' => " 24/7 Qo'llab-quvvatlash",
    'Adolatli_narxlar' => " Adolatli narxlar",
    '10_yillik_tajribaga_ega_mutaxasislar' => "10 yillik tajribaga ega mutaxasislar",
    'koproq_oqish' => "Ko'proq O'qish",
    'Batafsil' => "Batafsil",
    'Biz_bilan_oz_loyihangizni_yarating' => "Biz bilan o'z loyihangizni yarating",
    'biz_bilan_boglanish_uchun_pochta_manzilingizni_qoldiring!' => "biz bilan bog'lanish uchun pochta manzilingizni qoldiring!",
    'Emailingizni_kiriting:' => "Emailingizni kiriting:",
    ...
    'Mirobod_tumani' => "Mirobod tumani, Amir Temur shox ko’chasi, 31A uy",
